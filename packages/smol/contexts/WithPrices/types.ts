 ...
 *************************************************************************************************/
export type TPrices = Record<number, Record<TAddress, TNormalizedBN>>;

/**************************************************************************************************
 ** The TERC20TokensWithBalance type is used to type the token object. The following properties are available:
 ** - address: The address of the token.
 ** - chainID: The chain ID of the token.
 ** It's only used for some utils functions to work with the prices/tokens.
 *************************************************************************************************/
export type TPriceTokens = Pick<TERC20TokensWithBalance, 'address' | 'chainID'>[];
...
export type TPricesProps = {
	...
	getPrices: (tokens: TERC20TokensWithBalance[]) => Record<number, Record<TAddress, TNormalizedBN>>;
};
