	...
	const [toTokens, set_toTokens] = useState<TBasketToken[]>([
		...
		},
		{
			...
			token: {
				...
				chainID: 1,
				decimals: 6,
				logoURI: `${process.env.SMOL_ASSETS_URL}/token/1/0xdAC17F958D2ee523a2206206994597C13D831ec7/logo-128.png`,
				name: 'Tether USD',
				symbol: 'USDT',
				value: 0
			}
			...
			<div className={'flex flex-row gap-4'}>
				...
				<div className={'py-2'}>
					...
					<p className={'text-sm text-neutral-600'}>
						{
							"It's like having a steady hand in a chaotic market, keeping your assets as calm as a yoga class for sloths"
						}
					</p>
