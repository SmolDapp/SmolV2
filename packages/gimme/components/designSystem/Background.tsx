...
export function Background(): ReactElement {
	return (
		<>
			...
			{/* Bottom Left *********************************************************************/}
			<img
				className={'none invisible absolute bottom-0 left-0 z-10 w-[40vw] object-cover md:visible'}
				src={'/bottom-left.svg'}
				alt={'bottom-left'}
			/>
			<img
			...
			{/* Top Right ***********************************************************************/}
			<img
				className={'none invisible absolute right-0 top-0 z-10 w-2/5 object-cover md:visible'}
				src={'/top-right.svg'}
				alt={'top-right'}
			/>
			<img
			...
			<img
				className={'none invisible absolute left-0 top-0 z-10 w-2/5 object-cover md:visible'}
				src={'/top-left.svg'}
				alt={'top-left'}
			/>

			<img
				className={'none invisible absolute bottom-0 right-0 z-10 w-[45%] object-cover md:visible'}
