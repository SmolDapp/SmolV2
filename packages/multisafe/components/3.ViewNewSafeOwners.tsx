									...
									<div
										...
										<div
											...
											<button
												...
												tabIndex={-1}
												className={
													'bg-neutral-0 hover:text-neutral-0 flex size-10 items-center justify-center rounded-md border border-neutral-400/60 text-center text-xl text-neutral-600 transition-colors hover:bg-neutral-900'
												}
												onClick={(): void => onRemoveOwnerByUUID(UUID)}>
												<p className={'font-number pr-px'}>{'-'}</p>
											</button>
										</div>
									</div>
								)
										...
										<div className={'box-0 relative flex h-10 w-full items-center'}>
											...
											<div
												...
												<button
													type={'button'}
													className={
														'text-neutral-0 hover:bg-primary flex size-6 items-center justify-center rounded-md bg-neutral-600 text-center outline outline-offset-2 transition-colors disabled:opacity-10'
													}
