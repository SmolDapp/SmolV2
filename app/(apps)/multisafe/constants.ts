...
export const ALTERNATE_FALLBACK_HANDLER = toAddress('0x017062a1dE2FE6b99BE3d9d37841FeD19F573804'); // 1.3.0
...
export const PROXY_FACTORY_1_4_1 = toAddress('0x4e1DCf7AD4e460CfD30791CCC4F9c8a4f820ec67'); // 1.4.1
export const SINGLETON_1_4_1 = toAddress('0x41675C099F32341bf84BFc5382aF534df5C7461a'); // 1.4.1
export const FALLBACK_HANDLER_1_4_1 = toAddress('0xfd0732Dc9E303f09fCEf3a7388Ad10A83459Ec99'); // 1.4.1
